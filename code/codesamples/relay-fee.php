...
<head>
	...
	<script type="text/javascript">
 	function getFee(cardno, acq){
		...
		self.xmlHttpReq.open('POST', "webservice_fee.php?merchantnumber="+document.forms['ePay'].merchantnumber.value +"&cardno_prefix=" + cardno + "&acquirer=" + acq + "&amount="+document.forms['ePay'].amount.value +"&currency="+document.forms['ePay'].currency.value +"", true);
...
The full documentation of the ePay relay script is to be found here: <a href="http://www.epay.dk/support/integration.asp?solution=2" target="_blank">http://www.epay.dk/support/integration.asp?solution=2</a>.
...
<table cellspacing="0" cellpadding="3" style="width: 800px;">
		...
		<tr>
			<td>Card no:</td>
			<td>
				<input type="text" name="cardno" onkeyup="getFee(this.value, 1)"  style="width: 200px;" />
			</td>
			<td>
		...
		<tr>
			...
			<td>
				<div id="div_transfee"></div><input type="hidden" name="transfee" />
			</td>
			<td>
				The transaction fee calculated by the ePay Webservice. The hidden field named <b>transfee</b> will be set to this value in minor units.
			</td>
		</tr>
		<tr>
			<td>AcceptURL:</td>
		...
		<tr>
			<td>CallbackURL:</td>
			<td>
				<input type="text" name="callbackurl" value="<?php echo str_replace("relay-fee.php", "callback.php", curPageURL()); ?>" />
			</td>
			<td>
		...
		<tr>
			<td>&nbsp;</td>
			<td><input type="submit" name="submit" value="Pay" class="button" disabled="true" style="width: 200px;"></td>
