...
To secure your payments ePay return a MD5 stamp of the payment. You are able to check this stamp and see if it is matching the payment. 
...
The MD5 Key returned from ePay is calculated from the following parameters:
<ul>
	<li>Amount</li>
	<li>Order ID</li>
...
To calculate the MD5 key received from ePay please fill out the form below.
<br /><br />
...
<form action="from-ePay.php" method="post">
<table cellspacing="0" cellpadding="3" style="width: 800px;">
	...
	<tr>
		...
		<td>
			<input type="text" name="tid" value="" style="width: 200px;" />
		</td>
		<td>
			The unique transaction ID given by ePay.
		</td>
	</tr>
	<tr>
		<td>Secret Key:</td>
