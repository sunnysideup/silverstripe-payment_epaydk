...
class EpaydkPayment extends Payment
{
    ...
    public static $submit_url = "https://ssl.ditonlinebetalingssystem.dk/popup/default.asp";
    public static $logo = "payment_epaydk/images/epay_logo.gif";

    public static $merchant_number;
    public static $md5key = null;
    public static $language = 2;
    public static $limit_card_types = null;
    public static $auth_sms = null,$auth_mail = null;
    ...
    public static function set_merchant_number($number)
    {
        self::$merchant_number = $number;
    }

    public static function set_md5key($key)
    {
        self::$md5key = $key;
    }
     ...
     */
    public static function set_cardtypes($types)
    {
        self::$limit_card_types = $types;
    }
    
    public static function set_sms_number($number)
    {
    ...
    public static function set_google_tracker($gt)
    {
        self::$google_tracker = $gt;
    }
    
    public static function set_use3d($value)
    {
    ...
    public static function add_fee($add = true)
    {
        self::$add_fee = $add;
    }
