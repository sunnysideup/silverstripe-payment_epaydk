...
class EpaydkPayment extends Payment {
	...
	static $sumit_url = "https://ssl.ditonlinebetalingssystem.dk/popup/default.asp";
	...
	static $auth_sms = null,$auth_email = null;
...
JS;
		...
		$fields = new FieldSet(new HiddenField('merchantnumber', 'Merchant Number', self::$merchant_number), new HiddenField('orderid', 'Order ID', $this->ID), //uses payment id, rather than paid for id incase there are multiple payments
	 ...
	 */
	static $supported_currencies = array (
		'AFA' => array (
			'code' => '004',
			'name' => 'Afghani',
